...
helper = {"F": "if", "E": "else", "I": "elif", "q": "==", "M": ">", "L": "<", "m": ">=", "l": "<=", "n": "in", "o": "not", "a": "=", "p": "(", "P": ")", "b": "[", "B": "]", "d": "and", "r": "or", "u": "+", "i": "-", "X": "/", "k": "*", "K": "%", "w": "int", "W": "str", "O": "float", "h": "list", "H": "set", "t": "True", "f": "False", "N": "None", "c": ",", "z": " ", "s": "+=", "x": "-=", "U": "\"", "T": "print", "D": "def", "g": "input", "y": "for", "Y": "range", "j": "len", "J": ":", "v": "V"}
